...
<div class="container" id="about">
        ...
        <h1 class="h1-responsive font-weight-bold text-center my-4"> Terms of use </h1>
        
        <div class="col-md-6 offset-md-3 py-3">
            <h3 style="text-align: left;">Welcome to LearnIt!</h3>
        <p  >These terms and conditions outline the rules and regulations for the use of LearnIt's Website.</p>
        ...
        <p  >We employ the use of cookies. By using LearnIt's website you consent to the use of cookies
            in accordance with LearnIt’s privacy policy.</p>
        ...
        <h4 style="text-align: left;">License</h4>
        <p  >Unless otherwise stated, LearnIt and/or it’s licensors own the intellectual property rights for
            all material on LearnIt. All intellectual property rights are reserved. You may view and/or print
            pages from http://www.learnIt.com for your own personal use subject to restrictions set in these terms and
            conditions.</p>
        <p  >You must not:</p>
        <ol  >
            <li>Republish material from http://www.learnIt.com</li>
            <li>Sell, rent or sub-license material from http://www.learnIt.com</li>
            <li>Reproduce, duplicate or copy material from http://www.learnIt.com</li>
        </ol>
        <p  >Redistribute content from LearnIt (unless content is specifically made for redistribution).</p>
        <h4 style="text-align: left;">User Comments</h4>
        <ol  >
            <li>This Agreement shall begin on the date hereof.</li>
            <li>Certain parts of this website offer the opportunity for users to post and exchange opinions,
                information,
                material and data ('Comments') in areas of the website. LearnIt does not screen, edit, publish
                or review Comments prior to their appearance on the website and Comments do not reflect the views or
                opinions ofLearnIt, its agents or affiliates. Comments reflect the view and opinion of the
                person who posts such view or opinion. To the extent permitted by applicable laws LearnItshall
                ...
                website.</li>
            <li>LearnItreserves the right to monitor all Comments and to remove any Comments which it considers
            ...
            <li>You hereby grant to <strong>LearnIt</strong> a non-exclusive royalty-free license to use, reproduce,
                edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats
                or media.</li>
        </ol>
        <h4 style="text-align: left;">Hyperlinking to our Content</h4>
        <ol  >
        ...
        <p  >If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must notify us by sending an e-mail to <a href="mailto:contact@learnit.com" title="send an email to contact@learnit.com">contact@learnit.com</a>.
        ...
        <p  >No use of LearnIt’s logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
        <h4 style="text-align: left;">Iframes</h4>
        <p  >Without prior approval and express written permission, you may not create frames around our Web pages or
            use other techniques that alter in any way the visual presentation or appearance of our Web site.</p>
        <h4 style="text-align: left;">Reservation of Rights</h4>
        ...
        <h4 style="text-align: left;">Removal of links from our website</h4>
        ...
        <h4 style="text-align: left;">Content Liability</h4>
        ...
        <p></p>
        <h4 style="text-align: left;">Credit & Contact Information</h4>
