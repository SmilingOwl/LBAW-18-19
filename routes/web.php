...
Route::post('/api/member/{username}/toggle-follow', 'Profile\ProfileController@follow');
Route::post('/api/member/{username}/toggle-unfollow', 'Profile\ProfileController@unfollow');
