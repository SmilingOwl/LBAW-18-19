...
INSERT INTO "question"(id_question , title, description, "date", votes, photo, deleted, id_category, id_user) VALUES(5, 'What CBRNE agent inhibits the enzyme AChE allowing ACh to accumulate affecting the way cells transmit signals to the body?', 'I cannot find anything on my textbooks.', '2015-07-07 06:05:00' , 10, null, false, 8, 21);
...
INSERT INTO "answer"(id_answer, "text","date", votes, photo, deleted, id_question, user_post) VALUES(36, 'Awesome - even though I expected something different, namely a decrease with radius.', '2018-04-17 15:24:12', 1, NULL, false, 14, 8);
...
INSERT INTO "answer"(id_answer, "text","date", votes, photo, deleted, id_question, user_post) VALUES(70, 'This is enlightening. My second question simply if there are two counters at the source and screen c1 and c2 is c1= c2 at the end of a single photon at a time experiment (assuming all emitted photons will make it through the slits regardless of which slit or both at the same time)', '2018-05-08 02:23:55', 8, NULL, false, 38, 8);
...
INSERT INTO "answer"(id_answer, "text","date", votes, photo, deleted, id_question, user_post) VALUES(90, 'NSAID is a non-steroidal anti-inflammatory drug that inhibits various citokines responsible for the normal inflammatory response in your body. Some examples include TNF-alpha, IL-2, IL-6', '2018-05-14 16:57:42', 1, NULL, false, 57, 21);
