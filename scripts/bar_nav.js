...
function hyperSmallScreen() {
    ...
    div_bell_menu.innerHTML += '<a class="dropdown-item" href="./profile.html"><img class="item-1 rounded-circle" src="../images/user1.png" style="width: 1.8em;  border: 0.8px solid black; box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.1);"></img> <p class="item 2"style="margin:0px;font-size:13px;" > Luis started follow you </p><p> </p> <span class="item 3"> <i class="fa fa-clock-o" aria-hidden="true"></i>09/03/19</a></span>';
    div_bell_menu.innerHTML += '<a class="dropdown-item" href="./questionDetail.html"><img class="item-1 rounded-circle" src="../images/user1.png" style="width: 1.8em; border: 0.8px solid black; box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.1);"></img><p class="item 2" style="margin:0px;font-size:13px;"> Luis voted up your question  </p><p> </p> <span class="item 3"><i class="fa fa-clock-o" aria-hidden="true"></i>09/03/19</a></span>';
...
function superSmallScreen() {
    ...
    let div_bell_menu = document.createElement("div");
    div_bell_menu.setAttribute("class", "dropdown-menu dropdown-menu-right");
    div_bell_menu.innerHTML += '<a class="dropdown-item notification" href="./profile.html"><img class="item-1 rounded-circle" src="../images/user1.png" style="width: 1.8em; display: inline-block; border: 0.8px solid black; box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.1);"></img><p class="item 2" style="margin:0px; font-size:13px;"> Luis started follow you </p><p> </p><span class="item 3"><i class="fa fa-clock-o" aria-hidden="true" style="margin-right:5px;"></i>09/03/19</span></a>';
    div_bell_menu.innerHTML += '<a class="dropdown-item notification" href="./questionDetail.html"><img class="item-1 rounded-circle" src="../images/user1.png" style="width: 1.8em; display: inline-block; border: 0.8px solid black; box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.1);"></img><p class="item 2" style="margin:0px; font-size:13px;"> Luis voted up your question </p><p> </p><span class="item 3"><i class="fa fa-clock-o" aria-hidden="true" style="margin-right:5px;"></i>09/03/19</span></a>';
    div_bell.appendChild(div_bell_menu);
    let div = document.createElement("div");
    div.setAttribute("class", "btn-group");
...
function smallScreen() {
    ...
    let div_bell_menu = document.createElement("div");
    div_bell_menu.setAttribute("class", "dropdown-menu dropdown-menu-right");
    div_bell_menu.innerHTML += '<a class="dropdown-item notification" href="./profile.html"><img class="item-1 rounded-circle" src="../images/user1.png" style="width: 1.8em; display: inline-block; border: 0.8px solid black; box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.1);"></img><p style="margin:0px; class="item 2"font-size:13px;"> Luis started follow you </p><p> </p><span class="item 3"><i class="fa fa-clock-o" aria-hidden="true" style="margin-right:5px;"></i>09/03/19</span></a>';
    div_bell_menu.innerHTML += '<a class="dropdown-item notification" href="./questionDetail.html"><img class="item-1 rounded-circle " src="../images/user1.png" style="width: 1.8em; display: inline-block; border: 0.8px solid black; box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.1);"></img><p style="margin:0px; class="item 2" font-size:13px;"> Luis voted up your question </p><p> </p><span class="item 3"><i class="fa fa-clock-o" aria-hidden="true" style="margin-right:5px;"></i>09/03/19</span></a>';
    div_bell.appendChild(div_bell_menu);
    let div = document.createElement("div");
    div.setAttribute("class", "btn-group");
    div.innerHTML += '<button type="button" class="btn   dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-user"></i> Profile </button>';
