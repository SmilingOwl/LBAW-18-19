...
function onLoad() {
    ...
    div_group_drop_down.innerHTML = '<a class="dropdown-item" href="#"><img src="../images/logo.png" class="rounded dropdown-image-cat" alt="All"> All</a>';
    div_group_drop_down.innerHTML += '<a class="dropdown-item" href="#"><img src="../images/icon_dna.png" class="rounded dropdown-image-cat" alt="Biology"> Biology</a>';
    div_group_drop_down.innerHTML += '<a class="dropdown-item" href="#"><img src="../images/logo.png" class="rounded dropdown-image-cat" alt="Chemistry"> Chemistry</a>';
    div_group_drop_down.innerHTML += '<a class="dropdown-item" href="#"><img src="../images/logo.png" class="rounded dropdown-image-cat" alt="Maths"> Maths</a>';
    div_group_drop_down.innerHTML += '<a class="dropdown-item" href="#"><img src="../images/logo.png" class="rounded dropdown-image-cat" alt="Physics"> Physics</a>';
    div_group_drop_down.innerHTML += '<a class="dropdown-item" href="#"><img src="../images/logo.png" class="rounded dropdown-image-cat" alt="Geology"> Geology</a>';
    div_group_drop_down.innerHTML += '<a class="dropdown-item" href="#"><img src="../images/logo.png" class="rounded dropdown-image-cat" alt="Art"> Art</a>';
    div_group_drop_down.innerHTML += '<a class="dropdown-item" href="#"><img src="../images/logo.png" class="rounded dropdown-image-cat" alt="History"> History</a>';
    div_group_drop_down.innerHTML += '<a class="dropdown-item" href="#"><img src="../images/logo.png" class="rounded dropdown-image-cat" alt="Linguistics"> Linguistics</a>';
    div_group_drop_down.innerHTML += '<a class="dropdown-item" href="#"><img src="../images/logo.png" class="rounded dropdown-image-cat" alt="Health"> Health</a>';
    div_group_drop_down.innerHTML += '<a class="dropdown-item" href="#"><img src="../images/logo.png" class="rounded dropdown-image-cat" alt="Business"> Business</a>';
    div_group_drop_down.innerHTML += '<a class="dropdown-item" href="#"><img src="../images/logo.png" class="rounded dropdown-image-cat" alt="Technology"> Technology</a>';
    div_group_drop_down.innerHTML += '<a class="dropdown-item" href="#"><img src="../images/logo.png" class="rounded dropdown-image-cat" alt="Psychology"> Psychology</a>';
